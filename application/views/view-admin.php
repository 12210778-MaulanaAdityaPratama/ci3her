      ...
      <table class="table table-primary">
					...
					foreach($user as $row)
					{
						...
						<tr>
							...
							<td>
							<a href="<?php echo base_url(); ?>admin/edit/<?php echo $row->id; ?>" class="btn btn-warning">Edit</a>
							<a href="<?php echo base_url(); ?>admin/hapus/<?php echo $row->id; ?>" class="btn btn-danger">Hapus</a>
							</td>
						</tr>
						<?php
					}
